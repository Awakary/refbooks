    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'unique_together': {('refbook', 'version'), ('refbook', 'version', 'start_date')},
            },
        ),
        migrations.CreateModel(
            name='ElementRefBook',
            fields=[
                ...
                ('version', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='refbooks.versionrefbook', verbose_name='Версия справочника')),
            ],
            options={
